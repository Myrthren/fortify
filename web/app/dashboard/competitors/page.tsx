      ...
      <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-12">
        <div className="mb-8 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div className="anim-fade-up">
            ...
            <h1 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">Competitor Scanner</h1>
        ...
        {limit === 0 ? (
          ...
          <CompetitorScanner
            initial={competitors.map((c) => ({
              ...
              instagramReport: c.instagramReport as any ?? null,
              twitterReport: c.twitterReport as any ?? null,
              ...
              instagramScanAt: c.instagramScanAt ? c.instagramScanAt.toISOString() : null,
              twitterScanAt: c.twitterScanAt ? c.twitterScanAt.toISOString() : null,
              changeReport: c.changeReport as any ?? null,
              ...
              serpReport: c.serpReport as any ?? null,
              serpScanAt: c.serpScanAt ? c.serpScanAt.toISOString() : null,
