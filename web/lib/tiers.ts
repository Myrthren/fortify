...
export const TIER_LIMITS = {
  FREE: { dailyGenerations: 10, brandVoices: 0, monthlyAudits: 0, monthlyOutreach: 0, watchTerms: 0 },
  PRO: { dailyGenerations: Infinity, brandVoices: 1, monthlyAudits: 5, monthlyOutreach: 50, watchTerms: 0 },
  ELITE: { dailyGenerations: Infinity, brandVoices: 3, monthlyAudits: Infinity, monthlyOutreach: Infinity, watchTerms: 10 },
  APEX: { dailyGenerations: Infinity, brandVoices: Infinity, monthlyAudits: Infinity, monthlyOutreach: Infinity, watchTerms: Infinity },
} as const;
