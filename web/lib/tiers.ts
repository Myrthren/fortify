...
export const TIER_LIMITS = {
  FREE:  { dailyGenerations: 10,       brandVoices: 0,        monthlyAudits: 0,        monthlyOutreach: 0,        watchTerms: 0,        competitors: 0,        redditTrends: false, contentInspiration: false, ytCommentIntel: false, leadSourcing: false, metaAds: false, virality: false,              autoPublish: false, monthlyCredits: 0,    leadSourcingCost: 50 },
